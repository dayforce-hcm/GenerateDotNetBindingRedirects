...
namespace Dayforce.CSharp.ProjectAssets
{
    public static class C
    {
        ...
        {
            public static readonly NuGetVersion Value = new(1, 0, 0);
            public static readonly VersionRange Range = new(Value);
        }
        ...
        public static readonly StringPairOrdinalIgnoreCaseComparer IgnoreCase2 = new();
